...
class StaterkitController extends Controller
{
    ...
    public function column_1(){
        ...
        return view('admin.pages.sk-layout-1-column', [
    ...
    public function columns_2(){
        ...
        return view('admin.pages.sk-layout-2-columns', [
            'breadcrumbs' => $breadcrumbs
        ]);
    }
    ...
    public function fixed_navbar(){
        ...
        return view('admin.pages.sk-layout-fixed-navbar', [
    ...
    public function floating_navbar(){
        ...
        return view('admin.pages.sk-layout-floating-navbar', [
            'breadcrumbs' => $breadcrumbs
        ]);
    }
    ...
    public function fixed_layout(){
        ...
        return view('admin.pages.sk-layout-fixed', [
            'pageConfigs' => $pageConfigs,
            'breadcrumbs' => $breadcrumbs
        ]);
    }
    ...
    public function static_layout(){
        ...
        return view('admin.pages.sk-layout-static', [
            'pageConfigs' => $pageConfigs,
            'breadcrumbs' => $breadcrumbs
        ]);
    }
