        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/css/bootstrap-extended.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/colors.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/components.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/themes/dark-layout.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/themes/semi-dark-layout.css')) }}">
{{-- {!! Helper::applClasses() !!} --}}
@php
