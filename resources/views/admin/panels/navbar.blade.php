          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-language nav-item">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                ...
                <a class="dropdown-item" href="{{url('admin/lang/kh')}}" data-language="kh">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ auth('admin')->user()->name }}</span><span class="user-status">Available</span></div><span><img class="round"
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item" onclick="document.getElementById('logout-form').submit();"><i
                    class="feather icon-power"></i> {{ __('general.logout') }}</a>
